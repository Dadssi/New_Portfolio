...
$res = $conn->query("SELECT id, title, image, writer, domain, tags, created_at FROM articles ORDER BY id DESC");
?>
...
<h1>Articles</h1>
<p><a class="btn" href="add.php">+ Ajouter un article</a> <a class="btn" href="../dashboard.php">⟵ Dashboard</a></p>
<table>
<thead><tr><th>ID</th><th>Image</th><th>Titre</th><th>Auteur</th><th>Domaine</th><th>Tags</th><th>Créé le</th><th>Actions</th></tr></thead>
<tbody>
